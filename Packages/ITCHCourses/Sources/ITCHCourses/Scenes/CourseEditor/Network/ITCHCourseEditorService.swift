...
final class ITCHCourseEditorService: ITCHCourseEditorWorker {
    // MARK: - Private fiels
    ...
    func changeCourse(
        ...
        let endpoint = ITCHCourseEditorEndpoint.changeCourse(token: token, id: id)
